...
المتطلّب الحاجب (`fail_closed`) الذي لا يُوفى يُنتِج **حجباً** لا قيمةً ناقصة،
لأنّ القيمة الناقصة تُغري بارتدادٍ إلى الخام عند المستهلك — وهو ما تمنعه
هذه الشريحة أصلاً.
...
class ContextResolver:
    ...
    def _record_absence(
        ...
        حتّى المتطلّب غير الحاجب وغير المطلوب يترك أثراً في `limitations`:
        سياقٌ ينقصه شيءٌ ولا يقول ذلك يُقرأ سياقاً كاملاً.
        """
