...
TOOLS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        "يقرأ إنتاجيّة المياه/الكفاءة المائيّة للحقل (ماء مُستهلَك مقابل غلّة/حيويّة). قراءة فقط.",
        RISK_LOW,
        CAN_READ_FIELD_DATA,
        False,
        False,
    ...
    ToolSpec(
        "generate_report",
        "يجمّع تقرير حقل موحّداً للعرض/التصدير (بطاقة الذكاء + الحالة + الأدلّة). قراءة/تكوين فقط، لا إرسال.",
        RISK_LOW,
        CAN_READ_FIELD_DATA,
        False,
        False,
        {"field_id": "str", "period": "str?"},
    ),
    ToolSpec(
