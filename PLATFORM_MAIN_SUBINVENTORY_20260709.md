...
|---|---|---:|---:|
| `idempotency_outbox_events` | `embedded_business_logic` | 9 | 418 |
...
- Embedded business logic still present in platform main: `687` LOC.
...
| `_evaluate_field_alerts_persist` | `field_task_alert_helpers` | `embedded_business_logic` | 183 | 1674-1856 |
| `_log_alert_deliveries` | `field_task_alert_helpers` | `embedded_business_logic` | 60 | 1602-1661 |
| `_emit_domain_event` | `idempotency_outbox_events` | `embedded_business_logic` | 45 | 685-729 |
| `rate_limit_middleware` | `middleware_and_rate_limit` | `middleware_runtime` | 41 | 901-941 |
| `_start_outbox_worker` | `idempotency_outbox_events` | `embedded_business_logic` | 38 | 545-582 |
| `get_current_user` | `auth_jwt_permissions` | `security_runtime` | 37 | 1178-1214 |
| `_init_db_pool` | `db_tenant_rls_bootstrap` | `bootstrap_runtime` | 36 | 231-266 |
| `_idempotent` | `idempotency_outbox_events` | `embedded_business_logic` | 36 | 758-793 |
| `_assert_db_role_rls_safe` | `auth_jwt_permissions` | `security_runtime` | 33 | 269-301 |
| `require_permission` | `auth_jwt_permissions` | `security_runtime` | 31 | 1217-1247 |
| `_reverse_geocode` | `parsers_mappers_serializers` | `compatibility_runtime` | 29 | 1295-1323 |
| `_build_denylist` | `auth_jwt_permissions` | `security_runtime` | 27 | 1146-1172 |
| `_build_walk_plan` | `field_task_alert_helpers` | `embedded_business_logic` | 26 | 2107-2132 |
| `tenant_connection` | `db_tenant_rls_bootstrap` | `bootstrap_runtime` | 24 | 628-651 |
| `_row_to_activity` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1437-1460 |
| `_row_to_soil_test` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1510-1533 |
| `_build_versioned_update` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 23 | 1064-1086 |
| `_get_workflow_store` | `workflow_compatibility` | `compatibility_runtime` | 23 | 2484-2506 |
| `_build_rate_redis` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 21 | 854-874 |
