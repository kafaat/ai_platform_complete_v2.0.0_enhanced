...
| `_evaluate_field_alerts_persist` | `field_task_alert_helpers` | `embedded_business_logic` | 183 | 1665-1847 |
| `_log_alert_deliveries` | `field_task_alert_helpers` | `embedded_business_logic` | 60 | 1593-1652 |
| `_emit_domain_event` | `idempotency_outbox_events` | `embedded_business_logic` | 42 | 685-726 |
| `rate_limit_middleware` | `middleware_and_rate_limit` | `middleware_runtime` | 41 | 892-932 |
| `_start_outbox_worker` | `idempotency_outbox_events` | `embedded_business_logic` | 38 | 545-582 |
| `get_current_user` | `auth_jwt_permissions` | `security_runtime` | 37 | 1169-1205 |
...
| `require_permission` | `auth_jwt_permissions` | `security_runtime` | 31 | 1208-1238 |
| `_idempotent` | `idempotency_outbox_events` | `embedded_business_logic` | 30 | 755-784 |
| `_reverse_geocode` | `parsers_mappers_serializers` | `compatibility_runtime` | 29 | 1286-1314 |
| `_build_denylist` | `auth_jwt_permissions` | `security_runtime` | 27 | 1137-1163 |
| `_build_walk_plan` | `field_task_alert_helpers` | `embedded_business_logic` | 26 | 2098-2123 |
| `tenant_connection` | `db_tenant_rls_bootstrap` | `bootstrap_runtime` | 24 | 628-651 |
| `_row_to_activity` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1428-1451 |
| `_row_to_soil_test` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1501-1524 |
| `_build_versioned_update` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 23 | 1055-1077 |
| `_get_workflow_store` | `workflow_compatibility` | `compatibility_runtime` | 23 | 2475-2497 |
| `_build_rate_redis` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 21 | 845-865 |
