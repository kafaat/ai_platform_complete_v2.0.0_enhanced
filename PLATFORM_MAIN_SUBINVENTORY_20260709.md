...
|---|---|---:|---:|
| `idempotency_outbox_events` | `embedded_business_logic` | 9 | 424 |
...
- Embedded business logic still present in platform main: `693` LOC.
...
|---|---|---|---:|---|
| `_start_scheduler` | `idempotency_outbox_events` | `embedded_business_logic` | 231 | 304-534 |
| `_evaluate_field_alerts_persist` | `field_task_alert_helpers` | `embedded_business_logic` | 183 | 1680-1862 |
| `_log_alert_deliveries` | `field_task_alert_helpers` | `embedded_business_logic` | 60 | 1608-1667 |
| `_emit_domain_event` | `idempotency_outbox_events` | `embedded_business_logic` | 47 | 685-731 |
| `rate_limit_middleware` | `middleware_and_rate_limit` | `middleware_runtime` | 41 | 907-947 |
| `_idempotent` | `idempotency_outbox_events` | `embedded_business_logic` | 40 | 760-799 |
| `_start_outbox_worker` | `idempotency_outbox_events` | `embedded_business_logic` | 38 | 545-582 |
| `get_current_user` | `auth_jwt_permissions` | `security_runtime` | 37 | 1184-1220 |
...
| `require_permission` | `auth_jwt_permissions` | `security_runtime` | 31 | 1223-1253 |
| `_reverse_geocode` | `parsers_mappers_serializers` | `compatibility_runtime` | 29 | 1301-1329 |
| `_build_denylist` | `auth_jwt_permissions` | `security_runtime` | 27 | 1152-1178 |
| `_build_walk_plan` | `field_task_alert_helpers` | `embedded_business_logic` | 26 | 2113-2138 |
| `tenant_connection` | `db_tenant_rls_bootstrap` | `bootstrap_runtime` | 24 | 628-651 |
| `_row_to_activity` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1443-1466 |
| `_row_to_soil_test` | `parsers_mappers_serializers` | `compatibility_runtime` | 24 | 1516-1539 |
| `_build_versioned_update` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 23 | 1070-1092 |
| `_get_workflow_store` | `workflow_compatibility` | `compatibility_runtime` | 23 | 2490-2512 |
| `_build_rate_redis` | `misc_bootstrap_compatibility` | `bootstrap_compatibility` | 21 | 860-880 |
