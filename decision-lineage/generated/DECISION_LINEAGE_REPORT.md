...
|---:|---|---|---:|
| 1 | `evidence` | `sahool-platform` | 557 |
| 2 | `candidate` | `sahool-platform` | 480 |
| 3 | `decision` | `sahool-platform` | 168 |
| 4 | `review` | `sahool-platform` | 238 |
...
| 10 | `learning` | `sahool-platform` | 273 |
