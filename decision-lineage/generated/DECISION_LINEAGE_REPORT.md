...
|---:|---|---|---:|
| 1 | `evidence` | `sahool-platform` | 561 |
| 2 | `candidate` | `sahool-platform` | 482 |
| 3 | `decision` | `sahool-platform` | 170 |
| 4 | `review` | `sahool-platform` | 240 |
...
| 10 | `learning` | `sahool-platform` | 274 |
