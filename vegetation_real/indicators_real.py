...
FIELDS = {
    "field_01": {"name":"حقل وادي سبأ",        "lat":15.05,"lon":45.55,"area_ha":23.5,"crop":"قمح صلب",   "soil":"loam",       "planted":"2026-01-15"},
    "field_02": {"name":"حقل البيضاء الشمالي","lat":15.02,"lon":45.58,"area_ha":32.0,"crop":"شعير",       "soil":"clay_loam",  "planted":"2026-01-20"},
    "field_03": {"name":"حقل البيضاء الجنوبي","lat":14.98,"lon":45.52,"area_ha":18.7,"crop":"ذرة صفراء",  "soil":"sandy_loam", "planted":"2026-02-01"},
    "field_04": {"name":"حقل رداع الغربي",    "lat":14.92,"lon":45.48,"area_ha":41.3,"crop":"طماطم",      "soil":"loam",       "planted":"2026-02-10"},
    "field_05": {"name":"حقل ذي السفال",      "lat":14.88,"lon":45.60,"area_ha":28.9,"crop":"قمح صلب",   "soil":"silt_loam",  "planted":"2026-01-18"},
    "field_06": {"name":"حقل عتمة الشرقي",   "lat":15.10,"lon":45.62,"area_ha":37.5,"crop":"شعير",       "soil":"clay_loam",  "planted":"2026-01-25"},
    "field_07": {"name":"حقل الرياشية",       "lat":15.00,"lon":45.45,"area_ha":22.1,"crop":"خضروات",     "soil":"loam",       "planted":"2026-03-01"},
    "field_08": {"name":"حقل ذي ناعم",        "lat":14.85,"lon":45.65,"area_ha":45.0,"crop":"بطاطس",      "soil":"sandy_loam", "planted":"2026-02-15"},
}

# قاعدة بيانات تربة البيضاء اليمن (من دراسات FAO Yemen + ISRIC SoilGrids)
SOIL_BASELINE = {
    "loam":       {"ph":6.8,"ec":1.1,"om":2.1,"n_kg_ha":45,"p_mg_kg":18,"k_mg_kg":220,"bulk_density":1.35},
    "clay_loam":  {"ph":7.2,"ec":1.4,"om":2.5,"n_kg_ha":55,"p_mg_kg":22,"k_mg_kg":280,"bulk_density":1.30},
    "sandy_loam": {"ph":6.5,"ec":0.9,"om":1.5,"n_kg_ha":30,"p_mg_kg":12,"k_mg_kg":160,"bulk_density":1.50},
    "silt_loam":  {"ph":6.9,"ec":1.2,"om":2.3,"n_kg_ha":50,"p_mg_kg":20,"k_mg_kg":240,"bulk_density":1.38},
}
...
def _soil_nitrogen_from_om(om_pct: float, rain_14d: float,
                            et0_14d: float, crop: str) -> dict:
    """
    ...
    crop_n_req = {"قمح صلب": 120, "شعير": 100, "ذرة صفراء": 180,
                  "طماطم": 200, "بطاطس": 160, "خضروات": 140}
    ...
    return {
        ...
        "recommendation_ar": f"أضف {round(n_deficit * 2.17, 1)} كجم يوريا/هكتار" if n_deficit > 10 else "النيتروجين كافٍ",
    }
...
async def compute_all_indicators(field_id: str) -> dict:
    ...
    indicators = {
        ...
        "ndvi": {
            ...
            "status": _classify(ndvi, [(0.7,"excellent"),(0.5,"good"),(0.35,"fair"),(0.2,"poor")]),
        },
        "evi": {
            "value": evi, "unit": "[-1,1]",
            "label": "الغطاء النباتي المحسّن",
            "source": "sentinel-2",
            "status": _classify(evi, [(0.6,"excellent"),(0.45,"good"),(0.3,"fair"),(0.15,"poor")]),
        },
        "savi": {
            "value": savi, "unit": "[-1,1]",
            "label": "مؤشر تصحيح التربة",
            "source": "sentinel-2",
            "status": _classify(savi, [(0.65,"excellent"),(0.48,"good"),(0.32,"fair"),(0.18,"poor")]),
        },
        "gndvi": {
            "value": gndvi, "unit": "[-1,1]",
            "label": "مؤشر الكلوروفيل",
            "source": "sentinel-2",
            "status": _classify(gndvi, [(0.65,"excellent"),(0.48,"good"),(0.32,"fair"),(0.18,"poor")]),
        },
        "lai": {
            "value": lai, "unit": "m²/m²",
            "label": "مؤشر مساحة الأوراق",
            "source": "baret-1991",
            "status": _classify(lai, [(5.0,"excellent"),(3.0,"good"),(1.5,"fair"),(0.5,"poor")]),
        },
        # ── فئة المياه (Water) ────────────────────────────────
        "ndwi": {
            "value": ndwi, "unit": "[-1,1]",
            ...
            "source": "sentinel-2",
            "status": _classify(ndwi, [(0.1,"excellent"),(-0.05,"good"),(-0.2,"fair"),(-0.4,"poor")]),
        },
        "et0": {
        ...
        "water_use_eff": {
            ...
            "status": _classify(_water_use_efficiency(yield_est * 1000, etc_mm),
        ...
        "soil_nitrogen": {
            ...
            "status": _classify(n_info["n_available_kg_ha"],
        ...
        "organic_matter": {
            ...
            "source": "isric-soilgrids-yemen",
            "status": _classify(soil["om"], [(3.0,"excellent"),(2.0,"good"),(1.0,"fair"),(0.5,"poor")]),
        },
        ...
        "gdd": {
            ...
            "status": _classify(progress, [(80,"excellent"),(50,"good"),(25,"fair"),(10,"poor")]),
        ...
        "heat_stress": {
            ...
            "status": _classify_inverse(stress.get("heat_stress_index", 0),
        ...
        "yield_estimate": {
            ...
            "status": _classify(yield_est, [(4.0,"excellent"),(2.5,"good"),(1.5,"fair"),(0.8,"poor")]),
...
@app.get("/healthz")
@app.get("/health")
async def health(): return {"status": "alive", "mode": "real-data"}
