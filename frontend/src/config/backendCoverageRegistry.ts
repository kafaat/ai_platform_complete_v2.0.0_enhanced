...
export const BACKEND_COVERAGE_REGISTRY: BackendCoverageLayer[] = [
  ...
  },
  {
    ...
    hooks: ['useFieldSoilMoisture', 'useSoilNRecommendation', 'useScoutingTaxonomy', 'useScoutingPins'],
    surfaces: [
    ...
    gap: 'Diagnostics are distributed across pages; no unified diagnostic workbench ranks soil/lab/IPM evidence together.',
    nextAction: 'Add Diagnostic Evidence Workbench card or page wired to Objective Engine stress diagnosis.',
  },
  {
    ...
    hooks: ['useScenarioCompare', 'useReplaySeason'],
    surfaces: [
    ...
    gap: 'Scenario and replay are visible, but crop-twin assumptions and uncertainty are not surfaced as a governed contract.',
    nextAction: 'Add scenario assumption table and uncertainty/readiness gates before accepting simulated recommendations.',
  },
  {
