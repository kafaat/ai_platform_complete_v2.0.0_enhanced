...
const WORKER_PAGES: PageId[] = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'portfolio', 'calibration', 'lineage', 'learning-dashboard', 'decision-studio', 'agronomic-timeline', 'weather-advice', 'pest-escalation', 'field-intelligence',
