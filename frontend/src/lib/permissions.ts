...
const ALL_PAGES: PageId[] = [
  'dashboard', 'command', 'map-center', 'tasks-cabin', 'rec-flow', 'field-app', 'hybrid-index', 'satellite', 'fields', 'recommendations',
...
const WORKER_PAGES: PageId[] = [
  'dashboard', 'command', 'map-center', 'tasks-cabin', 'rec-flow', 'field-app', 'satellite', 'fields', 'tasks', 'activities', 'alerts', 'chatbot', 'spatial-indicators',
