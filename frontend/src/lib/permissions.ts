...
const ALL_PAGES = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'nl-gis', 'portfolio', 'portfolio-command', 'calibration', 'calibration-workbench', 'lineage', 'evidence-map', 'replay-map', 'learning-dashboard', 'decision-studio', 'execution-feedback', 'agronomic-timeline', 'weather-advice', 'irrigation-ops', 'irrigation-network', 'pest-escalation', 'field-intelligence',
...
const WORKER_PAGES: PageId[] = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'nl-gis', 'portfolio', 'portfolio-command', 'calibration', 'lineage', 'evidence-map', 'replay-map', 'learning-dashboard', 'decision-studio', 'execution-feedback', 'agronomic-timeline', 'weather-advice', 'pest-escalation', 'field-intelligence',
