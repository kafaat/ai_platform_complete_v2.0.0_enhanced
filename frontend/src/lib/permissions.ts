...
const ALL_PAGES = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'portfolio', 'calibration', 'lineage', 'learning-dashboard', 'weather-advice', 'irrigation-ops', 'pest-escalation', 'field-intelligence',
...
const WORKER_PAGES: PageId[] = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'portfolio', 'calibration', 'lineage', 'learning-dashboard', 'weather-advice', 'pest-escalation', 'field-intelligence',
