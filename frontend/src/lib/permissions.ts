...
const ALL_PAGES = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'portfolio', 'portfolio-command', 'calibration', 'calibration-workbench', 'lineage', 'learning-dashboard', 'decision-studio', 'agronomic-timeline', 'weather-advice', 'irrigation-ops', 'pest-escalation', 'field-intelligence',
...
const WORKER_PAGES: PageId[] = [
  ...
  'irrigation', 'irrigation-plan', 'crop-state', 'scenario-compare', 'portfolio', 'portfolio-command', 'calibration', 'lineage', 'learning-dashboard', 'decision-studio', 'agronomic-timeline', 'weather-advice', 'pest-escalation', 'field-intelligence',
