...
const ALL_PAGES = [
  ...
  'irrigation', 'irrigation-plan', 'weather-advice', 'irrigation-ops', 'pest-escalation', 'field-intelligence',
...
const WORKER_PAGES: PageId[] = [
  ...
  'irrigation', 'irrigation-plan', 'weather-advice', 'pest-escalation', 'field-intelligence',
