...
const ALL_PAGES: PageId[] = [
  ...
  'tasks', 'activities', 'field-ranking', 'problem-fields', 'analytics', 'alerts', 'reports', 'master-data', 'documents', 'governance', 'chatbot', 'settings',
];
...
const WORKER_PAGES: PageId[] = [
  'dashboard', 'unified-cabin', 'command', 'map-center', 'tasks-cabin', 'rec-flow', 'hybrid-monitor', 'analyze-cabin', 'setup-cabin', 'field-app', 'satellite', 'fields', 'tasks', 'activities', 'field-ranking', 'problem-fields', 'alerts', 'chatbot', 'spatial-indicators',
