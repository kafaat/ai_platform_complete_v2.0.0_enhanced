...
const ALL_PAGES: PageId[] = [
  'dashboard', 'command', 'field-app', 'hybrid-index', 'satellite', 'fields', 'recommendations',
...
const WORKER_PAGES: PageId[] = [
  'dashboard', 'command', 'field-app', 'satellite', 'fields', 'tasks', 'activities', 'alerts', 'chatbot', 'spatial-indicators',
