...
const ALL_PAGES: PageId[] = [
  'dashboard', 'field-app', 'hybrid-index', 'satellite', 'fields', 'recommendations',
...
const WORKER_PAGES: PageId[] = [
  'dashboard', 'field-app', 'satellite', 'fields', 'tasks', 'activities', 'alerts', 'chatbot', 'spatial-indicators',
