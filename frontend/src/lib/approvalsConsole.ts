...
// المحروسة بحالة pending_approval و(٣، WX-10.8) مرشّحات القرار الآمِرة المعلّقة.
// صدق: الموافِق المسجَّل هو هويّة البوّابة الموثوقة (SEC-3.1) لا حقل body؛
// والمخاطر/الأدلّة تُلوَّن/تُلخَّص للقيم المعروفة فقط بلا تسلسل الحمولة كاملةً.
