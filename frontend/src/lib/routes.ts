...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'climate-analogs',   path: '/crop/climate-analogs', label: 'النظائر المناخيّة', icon: CloudRain, maturity: 'beta' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'gis-expert',          path: '/advanced/gis-catalog',         label: 'كتالوج GIS السحابيّ (STAC/OGC)', icon: Layers, maturity: 'beta' },
