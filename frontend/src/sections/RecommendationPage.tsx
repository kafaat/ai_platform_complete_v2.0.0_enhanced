...
// كانت تعرض 3 سيناريوهات ثابتة («مثال توضيحي»). الآن تستدعي
// POST /api/v1/recommendations/for-field — الخادم يبني «شهادة الجودة» من
// ملاحظات المستأجر ثمّ يشغّل المحرّك. صدق: عند نقص البيانات تظهر حالة محجوبة/
// محدودة تُبيّن ما يلزم قياسه — لا رقم وهمي، ولا سيناريو مفبرَك.
// ════════════════════════════════════════════════════════════
  ...
  return (
    <div className="space-y-5 max-w-3xl mx-auto" dir="rtl">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-bold text-slate-100">التوصية المتكاملة</h2>
      </div>
