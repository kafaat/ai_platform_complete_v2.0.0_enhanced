...
| `edge-inference` | Edge Inference | 9 | 1110 | 1 | 6 | `services/edge-inference/main.py` | `services/edge-inference/Dockerfile.arm64` | `services/edge-inference/requirements.txt` | `normal` |
...
| `mcp_servers` | Agent Tools | 11 | 1914 | 1 | 33 | `-` | `services/mcp_servers/Dockerfile` | `services/mcp_servers/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 118 | 16583 | 44 | 77 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
| `raster-tiler-service` | Imagery & Raster | 0 | 0 | 0 | 0 | `-` | `services/raster-tiler-service/Dockerfile` | `-` | `medium-runtime-contract-gap` |
| `sahool-platform` | Core Field Platform | 959 | 128411 | 367 | 577 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `vegetation-analysis-service` | Vegetation Analytics | 9 | 1325 | 2 | 8 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
...
| `weather-service` | Weather Intelligence | 12 | 1466 | 5 | 15 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
