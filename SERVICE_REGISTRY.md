...
| `auth` | Identity & Access | 18 | 2248 | 2 | 27 | `services/auth/main.py` | `services/auth/Dockerfile` | `services/auth/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1031 | 141182 | 399 | 602 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
