...
| `raster-service` | Imagery & Raster | 161 | 22799 | 71 | 81 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1111 | 155071 | 437 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
