...
| `sahool-platform` | Core Field Platform | 1057 | 146697 | 409 | 616 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
