...
| `local-ai-rag` | Knowledge Retrieval | 3 | 637 | 1 | 5 | `services/local-ai-rag/main.py` | `services/local-ai-rag/Dockerfile` | `services/local-ai-rag/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1138 | 165524 | 458 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
