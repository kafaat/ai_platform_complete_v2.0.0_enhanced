...
| `sahool-platform` | Core Field Platform | 1137 | 163470 | 457 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `weather-service` | Weather Intelligence | 46 | 7317 | 27 | 28 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
