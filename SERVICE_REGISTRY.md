...
| `sahool-platform` | Core Field Platform | 1049 | 145561 | 408 | 616 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
