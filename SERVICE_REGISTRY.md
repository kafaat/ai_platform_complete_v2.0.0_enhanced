...
- Python LOC discovered: **227,280**
- Routes discovered: **1062**
...
| `scout-ingest-service` | Unclassified / Support | 4 | 598 | 2 | 5 | `services/scout-ingest-service/main.py` | `services/scout-ingest-service/Dockerfile` | `services/scout-ingest-service/requirements.txt` | `normal` |
