...
| `sahool-platform` | Core Field Platform | 1053 | 146260 | 408 | 616 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
