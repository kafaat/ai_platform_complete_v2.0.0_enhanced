...
| `ai_agronomist` | AI Advisor | 46 | 6056 | 1 | 13 | `services/ai_agronomist/main.py` | `services/ai_agronomist/Dockerfile` | `services/ai_agronomist/requirements.txt` | `normal` |
| `auth` | Identity & Access | 19 | 2361 | 2 | 29 | `services/auth/main.py` | `services/auth/Dockerfile` | `services/auth/requirements.txt` | `normal` |
| `decision-service` | Decision SoR | 73 | 16225 | 52 | 70 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `field-management-service` | Unclassified / Support | 3 | 469 | 2 | 7 | `services/field-management-service/main.py` | `services/field-management-service/Dockerfile` | `services/field-management-service/requirements.txt` | `normal` |
...
| `guardrails-engine` | AI Safety & Governance | 13 | 1564 | 1 | 8 | `services/guardrails-engine/main.py` | `services/guardrails-engine/Dockerfile` | `services/guardrails-engine/requirements.txt` | `normal` |
...
| `knowledge-graph` | Edge Inference | 3 | 353 | 1 | 7 | `services/knowledge-graph/main.py` | `services/knowledge-graph/Dockerfile` | `services/knowledge-graph/requirements.txt` | `normal` |
| `local-ai-rag` | Knowledge Retrieval | 2 | 526 | 1 | 5 | `services/local-ai-rag/main.py` | `services/local-ai-rag/Dockerfile` | `services/local-ai-rag/requirements.txt` | `normal` |
...
| `rag-retrieval` | Knowledge Retrieval | 2 | 142 | 1 | 5 | `services/rag-retrieval/main.py` | `services/rag-retrieval/Dockerfile` | `services/rag-retrieval/requirements.txt` | `normal` |
| `raster-service` | Imagery & Raster | 161 | 23321 | 71 | 82 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1130 | 159105 | 451 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `supervisor-agent` | Agent Orchestration | 22 | 2675 | 7 | 11 | `services/supervisor-agent/main.py` | `services/supervisor-agent/Dockerfile` | `services/supervisor-agent/requirements.txt` | `normal` |
...
| `weather-service` | Weather Intelligence | 38 | 6329 | 19 | 28 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
