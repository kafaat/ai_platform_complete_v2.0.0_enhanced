...
- Python LOC discovered: **233,619**
- Routes discovered: **1096**
...
| `decision-service` | Decision SoR | 59 | 13770 | 42 | 69 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 153 | 21132 | 65 | 80 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1085 | 150531 | 423 | 631 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
