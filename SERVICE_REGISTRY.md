...
| `sahool-platform` | Core Field Platform | 968 | 129536 | 375 | 580 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
