...
| `sahool-platform` | Core Field Platform | 1074 | 149428 | 416 | 629 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
