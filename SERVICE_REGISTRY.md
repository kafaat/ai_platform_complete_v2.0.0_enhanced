...
| `sahool-platform` | Core Field Platform | 997 | 132465 | 389 | 580 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
