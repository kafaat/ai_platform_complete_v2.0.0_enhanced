...
| `decision-service` | Decision SoR | 75 | 16489 | 54 | 70 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `knowledge-graph` | Edge Inference | 3 | 386 | 1 | 7 | `services/knowledge-graph/main.py` | `services/knowledge-graph/Dockerfile` | `services/knowledge-graph/requirements.txt` | `normal` |
...
| `rag-retrieval` | Knowledge Retrieval | 2 | 249 | 1 | 5 | `services/rag-retrieval/main.py` | `services/rag-retrieval/Dockerfile` | `services/rag-retrieval/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1139 | 167495 | 459 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
