...
| `sahool-platform` | Core Field Platform | 1063 | 147145 | 411 | 617 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
