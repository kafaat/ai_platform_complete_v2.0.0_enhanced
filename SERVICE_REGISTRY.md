...
- Python LOC discovered: **234,248**
- Routes discovered: **1097**
...
| `raster-service` | Imagery & Raster | 154 | 21740 | 65 | 81 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1085 | 150533 | 423 | 631 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
