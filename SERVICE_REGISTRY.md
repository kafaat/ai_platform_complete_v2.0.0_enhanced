...
| `sahool-platform` | Core Field Platform | 1120 | 156977 | 440 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
