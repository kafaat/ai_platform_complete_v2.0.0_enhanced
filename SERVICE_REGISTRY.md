...
| `sahool-platform` | Core Field Platform | 975 | 130585 | 380 | 580 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
