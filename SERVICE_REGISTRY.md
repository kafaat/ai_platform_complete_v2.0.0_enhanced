...
| `sahool-platform` | Core Field Platform | 1135 | 161342 | 454 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
