...
- Python LOC discovered: **179,748**
- Routes discovered: **880**
...
| `raster-service` | Imagery & Raster | 126 | 18425 | 48 | 78 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
| `raster-tiler-service` | Imagery & Raster | 0 | 0 | 0 | 0 | `-` | `services/raster-tiler-service/Dockerfile` | `-` | `medium-runtime-contract-gap` |
| `sahool-platform` | Core Field Platform | 961 | 128642 | 369 | 579 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `vegetation-analysis-service` | Vegetation Analytics | 9 | 1345 | 2 | 8 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
...
| `weather-service` | Weather Intelligence | 20 | 2667 | 8 | 20 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
