...
| `weather-service` | Weather Intelligence | 36 | 5414 | 18 | 26 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
