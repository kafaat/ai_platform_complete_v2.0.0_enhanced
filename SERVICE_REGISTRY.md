...
| `ai_agronomist` | AI Advisor | 46 | 6205 | 1 | 13 | `services/ai_agronomist/main.py` | `services/ai_agronomist/Dockerfile` | `services/ai_agronomist/requirements.txt` | `normal` |
...
| `local-ai-rag` | Knowledge Retrieval | 3 | 694 | 1 | 5 | `services/local-ai-rag/main.py` | `services/local-ai-rag/Dockerfile` | `services/local-ai-rag/requirements.txt` | `normal` |
...
| `rag-retrieval` | Knowledge Retrieval | 2 | 201 | 1 | 5 | `services/rag-retrieval/main.py` | `services/rag-retrieval/Dockerfile` | `services/rag-retrieval/requirements.txt` | `normal` |
| `raster-service` | Imagery & Raster | 164 | 23830 | 72 | 82 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1138 | 165905 | 458 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
