...
| `raster-service` | Imagery & Raster | 153 | 21149 | 65 | 80 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
