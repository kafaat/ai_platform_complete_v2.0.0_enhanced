...
| `sahool-platform` | Core Field Platform | 1138 | 164783 | 458 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
