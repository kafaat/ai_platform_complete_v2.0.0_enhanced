...
| `sahool-platform` | Core Field Platform | 1124 | 158499 | 443 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
