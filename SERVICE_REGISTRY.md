...
| `sahool-platform` | Core Field Platform | 1138 | 164300 | 458 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
