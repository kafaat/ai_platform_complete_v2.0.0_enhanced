...
| `sahool-platform` | Core Field Platform | 1131 | 160575 | 452 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
