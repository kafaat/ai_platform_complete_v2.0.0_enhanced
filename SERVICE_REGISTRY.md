...
| `sahool-platform` | Core Field Platform | 1113 | 155479 | 438 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
