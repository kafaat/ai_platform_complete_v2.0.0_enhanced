...
| `decision-service` | Decision SoR | 63 | 14293 | 45 | 69 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
