...
- Python LOC discovered: **229,358**
- Routes discovered: **1081**
...
| `scout-ingest-service` | Unclassified / Support | 7 | 2320 | 3 | 22 | `services/scout-ingest-service/main.py` | `services/scout-ingest-service/Dockerfile` | `services/scout-ingest-service/requirements.txt` | `normal` |
