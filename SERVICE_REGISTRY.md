...
| `edge-inference` | Edge Inference | 11 | 1365 | 2 | 6 | `services/edge-inference/main.py` | `services/edge-inference/Dockerfile.arm64` | `services/edge-inference/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1138 | 164626 | 458 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
