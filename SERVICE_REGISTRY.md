...
| `raster-service` | Imagery & Raster | 136 | 19308 | 54 | 78 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
