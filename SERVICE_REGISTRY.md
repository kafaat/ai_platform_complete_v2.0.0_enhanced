...
| `local-ai-rag` | Knowledge Retrieval | 2 | 517 | 1 | 5 | `services/local-ai-rag/main.py` | `services/local-ai-rag/Dockerfile` | `services/local-ai-rag/requirements.txt` | `normal` |
...
| `rag-retrieval` | Knowledge Retrieval | 2 | 144 | 1 | 5 | `services/rag-retrieval/main.py` | `services/rag-retrieval/Dockerfile` | `services/rag-retrieval/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1124 | 158622 | 443 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
