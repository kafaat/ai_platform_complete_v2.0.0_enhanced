...
| `raster-service` | Imagery & Raster | 161 | 22984 | 71 | 82 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
