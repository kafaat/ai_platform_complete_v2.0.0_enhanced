...
| `sahool-platform` | Core Field Platform | 1135 | 162233 | 455 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `weather-service` | Weather Intelligence | 42 | 6928 | 23 | 28 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
