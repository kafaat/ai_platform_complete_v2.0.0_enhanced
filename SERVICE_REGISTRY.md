...
- Python LOC discovered: **207,904**
- Routes discovered: **997**
...
| `sahool-platform` | Core Field Platform | 1010 | 135998 | 396 | 598 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
