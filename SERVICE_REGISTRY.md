...
| `scout-ingest-service` | Unclassified / Support | 2 | 271 | 1 | 3 | `services/scout-ingest-service/main.py` | `services/scout-ingest-service/Dockerfile` | `services/scout-ingest-service/requirements.txt` | `normal` |
