...
- Python LOC discovered: **188,307**
- Routes discovered: **890**
...
| `decision-service` | Decision SoR | 13 | 2363 | 3 | 16 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1001 | 133160 | 393 | 582 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
