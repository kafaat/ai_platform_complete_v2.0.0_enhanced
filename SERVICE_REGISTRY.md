...
| `rag-retrieval` | Knowledge Retrieval | 2 | 196 | 1 | 5 | `services/rag-retrieval/main.py` | `services/rag-retrieval/Dockerfile` | `services/rag-retrieval/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1131 | 160136 | 452 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
