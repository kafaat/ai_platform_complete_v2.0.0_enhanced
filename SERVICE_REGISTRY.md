...
- Python LOC discovered: **217,381**
- Routes discovered: **1016**
...
| `sahool-platform` | Core Field Platform | 1044 | 144836 | 404 | 616 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
