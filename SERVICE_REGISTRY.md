...
| `raster-service` | Imagery & Raster | 145 | 20429 | 60 | 79 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
