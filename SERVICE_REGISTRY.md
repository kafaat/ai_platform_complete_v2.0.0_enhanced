...
- Python LOC discovered: **203,212**
- Routes discovered: **953**
...
| `decision-service` | Decision SoR | 44 | 10631 | 31 | 52 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 144 | 20291 | 60 | 79 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
| `raster-tiler-service` | Imagery & Raster | 0 | 0 | 0 | 0 | `-` | `services/raster-tiler-service/Dockerfile` | `-` | `medium-runtime-contract-gap` |
| `sahool-platform` | Core Field Platform | 1008 | 134958 | 396 | 598 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `soil-service` | Soil Intelligence | 20 | 1885 | 4 | 15 | `services/soil-service/main.py` | `services/soil-service/Dockerfile` | `services/soil-service/requirements.txt` | `normal` |
