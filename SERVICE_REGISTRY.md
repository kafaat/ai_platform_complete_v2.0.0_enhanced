...
| `raster-service` | Imagery & Raster | 137 | 19347 | 55 | 78 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
