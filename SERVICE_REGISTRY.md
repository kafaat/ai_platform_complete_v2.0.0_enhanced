...
| `remote-sensing-workspace-bff` | Unclassified / Support | 2 | 192 | 1 | 3 | `services/remote-sensing-workspace-bff/main.py` | `services/remote-sensing-workspace-bff/Dockerfile` | `services/remote-sensing-workspace-bff/requirements.txt` | `normal` |
...
| `vegetation-analysis-service` | Vegetation Analytics | 36 | 3446 | 16 | 21 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
