...
| `sahool-platform` | Core Field Platform | 1068 | 148025 | 414 | 617 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
