...
| `sahool-platform` | Core Field Platform | 1133 | 161045 | 453 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
