...
- Python LOC discovered: **226,490**
- Routes discovered: **1060**
...
| `raster-service` | Imagery & Raster | 151 | 20986 | 64 | 79 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `scout-ingest-service` | Unclassified / Support | 4 | 524 | 2 | 4 | `services/scout-ingest-service/main.py` | `services/scout-ingest-service/Dockerfile` | `services/scout-ingest-service/requirements.txt` | `normal` |
