...
- Python LOC discovered: **187,352**
- Routes discovered: **888**
...
| `sahool-platform` | Core Field Platform | 998 | 132906 | 391 | 581 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
