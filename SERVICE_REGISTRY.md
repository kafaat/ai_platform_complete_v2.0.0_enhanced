...
| `sahool-platform` | Core Field Platform | 1116 | 156239 | 440 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
