...
| `sahool-platform` | Core Field Platform | 1080 | 150089 | 420 | 629 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
