...
| `sahool-platform` | Core Field Platform | 1060 | 146932 | 411 | 617 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
