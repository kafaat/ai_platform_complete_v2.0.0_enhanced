...
| `sahool-platform` | Core Field Platform | 1008 | 135156 | 396 | 598 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
