...
| `sahool-platform` | Core Field Platform | 1130 | 159276 | 451 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
