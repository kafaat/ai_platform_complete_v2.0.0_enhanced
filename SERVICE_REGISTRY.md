...
| `raster-service` | Imagery & Raster | 157 | 22115 | 67 | 81 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
