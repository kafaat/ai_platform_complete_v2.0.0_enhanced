...
- Python LOC discovered: **181,610**
- Routes discovered: **882**
...
| `weather-service` | Weather Intelligence | 27 | 3547 | 12 | 21 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
