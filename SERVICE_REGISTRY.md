...
| `sahool-platform` | Core Field Platform | 1084 | 150422 | 422 | 631 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
