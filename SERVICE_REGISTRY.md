...
- Python LOC discovered: **234,537**
- Routes discovered: **1098**
...
| `decision-service` | Decision SoR | 59 | 13781 | 42 | 69 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 155 | 21955 | 65 | 81 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1085 | 150607 | 423 | 632 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
