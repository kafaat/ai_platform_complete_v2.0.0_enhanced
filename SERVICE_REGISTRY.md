...
- Python LOC discovered: **186,079**
- Routes discovered: **887**
...
| `sahool-platform` | Core Field Platform | 996 | 132282 | 389 | 580 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `weather-service` | Weather Intelligence | 33 | 4877 | 16 | 26 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
