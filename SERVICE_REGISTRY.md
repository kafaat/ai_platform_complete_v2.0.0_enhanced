...
| `sahool-platform` | Core Field Platform | 1101 | 153421 | 429 | 636 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
