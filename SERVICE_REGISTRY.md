...
| `vegetation-analysis-service` | Vegetation Analytics | 40 | 3756 | 17 | 21 | `services\vegetation-analysis-service\main.py` | `services\vegetation-analysis-service\Dockerfile` | `services\vegetation-analysis-service\requirements.txt` | `normal` |
