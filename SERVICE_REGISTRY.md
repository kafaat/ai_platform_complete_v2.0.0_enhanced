...
| `sahool-platform` | Core Field Platform | 1136 | 162837 | 456 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
