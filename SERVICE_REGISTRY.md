...
- Python LOC discovered: **214,408**
- Routes discovered: **1002**
...
| `sahool-platform` | Core Field Platform | 1034 | 141932 | 400 | 602 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
