...
| `sahool-platform` | Core Field Platform | 1090 | 151987 | 425 | 635 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
