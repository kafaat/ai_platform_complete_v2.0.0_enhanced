...
| `sahool-platform` | Core Field Platform | 1092 | 152487 | 426 | 635 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
