...
- Python LOC discovered: **179,034**
- Routes discovered: **876**
...
| `sahool-platform` | Core Field Platform | 960 | 128484 | 368 | 578 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `weather-service` | Weather Intelligence | 16 | 2111 | 7 | 17 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
