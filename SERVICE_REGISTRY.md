...
| `sahool-platform` | Core Field Platform | 963 | 128858 | 371 | 579 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
