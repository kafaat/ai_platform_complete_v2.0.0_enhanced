...
- Python LOC discovered: **185,865**
- Routes discovered: **886**
...
| `weather-service` | Weather Intelligence | 32 | 4663 | 15 | 25 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
