...
- Python LOC discovered: **218,430**
- Routes discovered: **1019**
...
| `vegetation-analysis-service` | Vegetation Analytics | 21 | 2123 | 10 | 11 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
