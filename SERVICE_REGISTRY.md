...
| `sahool-platform` | Core Field Platform | 1104 | 154032 | 431 | 636 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
