...
- Python LOC discovered: **222,986**
- Routes discovered: **1040**
...
| `decision-service` | Decision SoR | 47 | 11631 | 33 | 53 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
