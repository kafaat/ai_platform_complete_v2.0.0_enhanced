...
| `sahool-platform` | Core Field Platform | 1121 | 157030 | 441 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
