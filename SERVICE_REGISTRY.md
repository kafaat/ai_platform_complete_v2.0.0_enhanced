...
| `sahool-platform` | Core Field Platform | 974 | 130387 | 379 | 580 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
