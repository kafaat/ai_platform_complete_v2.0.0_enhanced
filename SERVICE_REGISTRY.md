...
- Python LOC discovered: **256,874**
- Routes discovered: **1113**
...
| `sahool-platform` | Core Field Platform | 1138 | 164600 | 458 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
