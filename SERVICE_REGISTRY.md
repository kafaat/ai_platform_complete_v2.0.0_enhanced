...
| `sahool-platform` | Core Field Platform | 1083 | 150335 | 421 | 631 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
