...
| `sahool-platform` | Core Field Platform | 1010 | 135843 | 396 | 598 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
