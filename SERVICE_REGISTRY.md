...
| `sahool-platform` | Core Field Platform | 1031 | 141315 | 399 | 602 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
