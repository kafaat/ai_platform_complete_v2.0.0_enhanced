...
| `sahool-platform` | Core Field Platform | 1138 | 165710 | 458 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
