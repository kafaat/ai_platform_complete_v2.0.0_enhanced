...
- Python LOC discovered: **237,867**
- Routes discovered: **1104**
...
| `sahool-platform` | Core Field Platform | 1092 | 152495 | 426 | 636 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
