...
| `sahool-platform` | Core Field Platform | 1079 | 149995 | 419 | 629 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
