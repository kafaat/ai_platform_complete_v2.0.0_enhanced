...
- Python LOC discovered: **198,246**
- Routes discovered: **937**
...
| `decision-service` | Decision SoR | 39 | 9254 | 26 | 47 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `model-registry-adapter` | Unclassified / Support | 6 | 993 | 2 | 0 | `-` | `services/model-registry-adapter/Dockerfile` | `-` | `medium-runtime-contract-gap` |
...
| `sahool-platform` | Core Field Platform | 1002 | 134066 | 394 | 596 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
