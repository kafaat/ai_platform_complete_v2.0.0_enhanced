...
| `sahool-platform` | Core Field Platform | 1139 | 167373 | 459 | 638 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
