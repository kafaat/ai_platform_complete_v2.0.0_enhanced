...
| `sahool-platform` | Core Field Platform | 1106 | 154311 | 433 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
