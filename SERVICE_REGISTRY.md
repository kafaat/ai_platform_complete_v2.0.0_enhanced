...
- Python LOC discovered: **178,570**
- Routes discovered: **874**
...
| `weather-service` | Weather Intelligence | 14 | 1720 | 6 | 16 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
