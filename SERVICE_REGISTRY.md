...
- Python LOC discovered: **192,817**
- Routes discovered: **920**
...
| `decision-service` | Decision SoR | 26 | 5967 | 16 | 32 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
