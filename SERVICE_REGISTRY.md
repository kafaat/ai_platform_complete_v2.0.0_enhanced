...
| `sahool-platform` | Core Field Platform | 1085 | 150532 | 423 | 631 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
