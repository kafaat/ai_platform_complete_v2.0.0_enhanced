...
| `sahool-platform` | Core Field Platform | 1137 | 163159 | 457 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
