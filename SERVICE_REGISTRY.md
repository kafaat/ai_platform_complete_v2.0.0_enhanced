...
- Python LOC discovered: **198,890**
- Routes discovered: **939**
...
| `decision-service` | Decision SoR | 41 | 9838 | 28 | 49 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
