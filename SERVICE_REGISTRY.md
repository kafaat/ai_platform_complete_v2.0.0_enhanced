...
| `sahool-platform` | Core Field Platform | 1135 | 162243 | 455 | 637 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `weather-service` | Weather Intelligence | 43 | 6977 | 24 | 28 | `services/weather-service/main.py` | `services/weather-service/Dockerfile` | `services/weather-service/requirements.txt` | `normal` |
