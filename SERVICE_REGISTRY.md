...
| `odoo-bridge` | ERP Integration | 11 | 1606 | 2 | 10 | `services/odoo-bridge/main.py` | `services/odoo-bridge/Dockerfile` | `services/odoo-bridge/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 152 | 21074 | 64 | 80 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
...
| `vegetation-analysis-service` | Vegetation Analytics | 40 | 3751 | 17 | 21 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
