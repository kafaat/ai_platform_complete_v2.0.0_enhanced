...
- Python LOC discovered: **200,022**
- Routes discovered: **942**
...
|---|---:|---:|---:|---:|---:|---|---|---|---|
| `actuator-service` | IoT Actuation | 11 | 1329 | 4 | 6 | `services/actuator-service/main.py` | `services/actuator-service/Dockerfile` | `services/actuator-service/requirements.txt` | `normal` |
| `agriai-engine` | AI Advisor | 13 | 1263 | 5 | 8 | `services/agriai-engine/main.py` | `services/agriai-engine/Dockerfile` | `services/agriai-engine/requirements.txt` | `normal` |
...
| `decision-service` | Decision SoR | 43 | 10404 | 30 | 51 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `raster-service` | Imagery & Raster | 128 | 18817 | 49 | 78 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
| `raster-tiler-service` | Imagery & Raster | 0 | 0 | 0 | 0 | `-` | `services/raster-tiler-service/Dockerfile` | `-` | `medium-runtime-contract-gap` |
| `sahool-platform` | Core Field Platform | 1004 | 134457 | 395 | 597 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
...
| `vegetation-analysis-service` | Vegetation Analytics | 16 | 2037 | 7 | 10 | `services/vegetation-analysis-service/main.py` | `services/vegetation-analysis-service/Dockerfile` | `services/vegetation-analysis-service/requirements.txt` | `normal` |
