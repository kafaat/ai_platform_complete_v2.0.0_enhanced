...
| `sahool-platform` | Core Field Platform | 1067 | 147791 | 413 | 617 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
