...
- Python LOC discovered: **200,697**
- Routes discovered: **943**
...
| `decision-service` | Decision SoR | 43 | 10504 | 30 | 52 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
...
| `sahool-platform` | Core Field Platform | 1006 | 134799 | 396 | 597 | `services/sahool-platform/api/main.py` | `services/sahool-platform/Dockerfile` | `-` | `critical-core-concentration` |
