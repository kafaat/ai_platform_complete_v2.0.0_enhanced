...
| `qdrant-seed` | Unclassified / Support | 4 | 1018 | 1 | 0 | `-` | `services/qdrant-seed/Dockerfile` | `services/qdrant-seed/requirements.txt` | `medium-runtime-contract-gap` |
