...
- Python LOC discovered: **223,787**
- Routes discovered: **1046**
...
| `decision-service` | Decision SoR | 50 | 12432 | 35 | 59 | `services/decision-service/main.py` | `services/decision-service/Dockerfile` | `services/decision-service/requirements.txt` | `normal` |
