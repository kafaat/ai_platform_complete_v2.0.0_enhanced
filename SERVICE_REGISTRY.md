...
| `raster-service` | Imagery & Raster | 153 | 21527 | 65 | 81 | `services/raster-service/main.py` | `services/raster-service/Dockerfile` | `services/raster-service/requirements.txt` | `normal` |
