...
## MUT-REGISTRY-DUPLICATE-KEY-SHADOWS-A-BLOCK-01 — مفتوحة (2026-08-21)
...
- **ما لم يُفعَل — وشرطُ الإغلاق:** الحارسُ نفسُه. يحتاج قراءةَ **النصّ الخام** (`object_pairs_hook` أو مسحاً معجميّاً) لا الوثيقةَ المُحمَّلة، وطفرةً تزرع مفتاحاً مكرّراً فتُحمِّر اختباراً. شريحةٌ مستقلّة — لا تُخلَط بـD09.
