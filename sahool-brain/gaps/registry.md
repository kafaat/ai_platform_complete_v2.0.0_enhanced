...
## BIDI-CONTROL-CHAR-PASSED-THE-DEFAULT-PREFLIGHT-01 — `open` (الصنف) · `fixed` (الحالة) — 2026-08-12
...
## GUARD-DIES-PRINTING-ITS-OWN-SUCCESS-UNDER-C-LOCALE-01 — `open` (الصنف) · `fixed` (حالةٌ واحدة) — 2026-08-12
...
## GATE01-AUTHORIZATION-ORIGIN-UNENFORCED-01 — `open` (P0 · كشفها المالك 2026-08-13)
