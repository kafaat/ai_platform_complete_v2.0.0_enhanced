...
- **الشاهد الحاليّ:** `tests_v9/test_recommendation_runtime_reachability.py` — يقيس صفرَ المستهلكين ويربطه بحالة هذا القسم (مستهلكٌ يظهر بلا قلبِ الحالة ⇒ أحمر)، ويمنع استيرادَ `ai_agronomist` من شيفرة المنصّة عبر حدّ الحاوية.
