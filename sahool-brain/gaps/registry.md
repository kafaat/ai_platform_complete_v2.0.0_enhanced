...
- **تحديث قياس (2026-08-11، #824):** العدّ الدقيق **٢٣ موضعاً في ١٦ ملفّ workflow**، ببصمةٍ واحدة متمايزة (`ea165f8d…` ‏# v4)، و**لا مرساة خارج `.github/workflows/`** — لا حارس ولا اختبار ولا allowlist يحمل البصمة. وهذا **أضيق** من سطح ترقية `actions/attest` في #823 التي حملت **سبع مراسٍ** منها حارسٌ واختبار، فأخضرّت البوّابات على نصف ترقية. أي أنّ الاستبدال هنا ميكانيكيّ بحقّ، والقيد الوحيد الباقي هو حلّ البصمة.
- **مرشَّح وصل بلا تحقّق (2026-08-11):** حزمةٌ من المالك تقترح `043fb46d1a93c77aae656e7c1c64a875d1fc6a0a` بوصفه v7.0.1. **لم يُتحقَّق منه** — نطاق GitHub في جلسة الوكيل محصورٌ بهذا المستودع فلا يُقرأ `actions/upload-artifact`. وتثبيتُ SHA غرضُه بالضبط ألّا يُؤخَذ على الثقة، فنقلُ بصمةٍ غير محقَّقة إلى ٢٣ موضعاً يكتب في الشجرة ادّعاءً غير مُثبَت — وهو أسوأ من إبقاء تحذير Node 20. **ما ينقص لتنفيذها: من يُثبِّت ربط الوسم بالبصمة من مصدر أعلى.**
...
## COMPENSATION-BYPASSES-KILLSWITCH-01 — 🔴 OPEN · مُوثَّق تنفيذيّاً (2026-08-08 · M-01 في v06 · حاجب لأيّ real/cutover)
...
## MANUAL-COMMAND-KILLSWITCH-SCOPE-BLIND-01 — 🔴 OPEN · مُوثَّق تنفيذيّاً (2026-08-08 · M-02 في v06 · حاجب لأيّ real/cutover)
...
## GUC-SCOPE-GUARD-SEES-ONE-FILE-01 — 🔴 OPEN (2026-08-08، E5 من الفحص الجنائيّ لـv05)
