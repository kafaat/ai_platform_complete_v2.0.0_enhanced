...
> **آخر تحديث:** 2026-07-04 · `main` = `develop` = `claude/code-review-34hO3` = `7f8fd62`. [`log.md`](log.md) مدخل (ن-17، ن-16، ن-15). قوس الربحيّة كامل إدخالاً (عمليّة/موازنة/إيراد ⇒ تحديث حيّ) — العقد 55 endpoint. +التقويم اليمنيّ (منزلة/حميريّ/أمثال، display_only) و«ماذا أزرع؟» (دورة+ملاءمة شهر) — العقد 47 endpoint.
