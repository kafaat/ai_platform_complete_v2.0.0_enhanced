...
> **آخر تحديث:** 2026-07-04 · `main` = `develop` = `claude/code-review-34hO3` = `f5759d6`. [`log.md`](log.md) مدخل (ن-15، ن-14، ن-13). +التقويم اليمنيّ (منزلة/حميريّ/أمثال، display_only) و«ماذا أزرع؟» (دورة+ملاءمة شهر) — العقد 47 endpoint.
