...
> **آخر تحديث:** 2026-07-02 · `main` = الفرع = `9c69839` (دفع مباشر إلى main) · **أحدث: منع إعادة تشغيل TOTP (v141) — كل مسارات MFA الأربعة تستهلك الخطوة الزمنيّة ذرّيّاً** · [`log.md`](log.md) مدخل (ن-8).
