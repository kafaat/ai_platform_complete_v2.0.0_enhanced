...
> **آخر تحديث:** 2026-06-29 · رأس الفرع المخصّص `claude/code-review-34hO3`: [`d6d4b0d`](../) (CI أخضر) · [`log.md`](log.md) مدخل (ع).
> 🧩 **توحيد مكتمل + تفكيك main.py للمنصّة:** `main` superset كامل؛ نماذج Pydantic مُستخرَجة إلى
> `api/api_models.py` ثمّ عنقود السياق الزراعيّ إلى `api/field_context.py` (main.py 3282→**2523**). كلّ الـ11
> خدمة مُفكَّكة. الفرع المخصّص = main + إصلاح حارس المصدر + field_context (re-export، 526 مساراً ثابتاً).
> 0 PR مفتوح · 0 تعارض · `pytest -m unit` 1950 ✓.
