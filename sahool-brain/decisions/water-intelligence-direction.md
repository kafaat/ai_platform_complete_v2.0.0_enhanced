...
- **Kc ديناميكيّ من NDVI** — ✅ **منفَّذ (#461):** `core/engines/fao56.py` يضيف طريقة FAO-56 §9.4
  ...
  **رصداً** بدل العمر (حقل متأخّر/مُجهَد ⇒ NDVI أدنى ⇒ Kcb أصدق). **حفظ السلوك:** غياب NDVI ⇒
  ...
  الزراعة) والملوحة (أحدث فحص). تدرّج صادق: NDVI مفقود ⇒ Kcb عمريّ؛ مصدر كلّ قيمة مُعلَن. **متبقٍّ
  موثَّق:** جلب الطقس حيّاً (Open-Meteo) + جلب NDVI من COG الطازج + LAI/غطاء التاج + لوحة واجهة.
