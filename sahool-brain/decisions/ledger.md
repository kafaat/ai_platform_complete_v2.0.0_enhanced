...
**ورابعٌ بالسلب:** لم يُلمَس مشروعُ Railway الحيّ `sahool-staging`. السبب: قرارُ المالك الصريح، والارتباطُ المطلوب عقديٌّ — موضعُ v231 في `MANIFEST.txt` قبل `v206` كي لا ترفض صورةُ الترحيل العملَ، وهو مقيسٌ في الاتّجاهين.
