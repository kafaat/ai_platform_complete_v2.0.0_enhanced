...
- **القرار (اقترحه المالك، وافقه المراجع الرئيسيّ — يُصدَّق رسميّاً في SIM-GOLDEN-01، لا كود الآن):** تسلسل هرميّ مُعلَن للمحاكاة — **PCSE/WOFOST مرجعيّ (نقطة المعايرة الوحيدة)** · `season_simulation` استكشافيّ `screening_only` (يُمنَع جنب PCSE) · AquaCrop للمسار الملحيّ (ec_e≥2.0، محسوم). QUEFTS يتبع PCSE لا يُعايَر مستقلّاً.
