...
- **SHA:** `41fb073`+`0d5990f` (2a) · `66f65f0` (2b) · `360e3f3`+`288f5ad`+`7bb82e5` (ضريبة التسجيل) · `78ff445` (إصلاح طبقة CI الخفيفة). **الفجوتان:** MINIO-PER-SERVICE-CREDENTIALS · RUFF-FORMAT-DRIFT-SHARED.
