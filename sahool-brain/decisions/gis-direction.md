...
1. **حفظ مساحة العمل (`.sahool-project.json`)** — تسلسُل حالة MapHub (طبقات/أنماط/فلاتر/رسومات/
   صور مختارة/مشاهد) فيعود المستخدم لنفس البيئة. **الأكثر اكتفاءً ذاتيّاً + أعلى قيمة فوريّة**
   (يبني على MapHub القائم). — **الأولويّة الأولى الموصى بها.**
