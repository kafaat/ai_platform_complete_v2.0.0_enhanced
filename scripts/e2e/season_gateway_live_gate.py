...
# TLS عبر السياسة المركزيّة (shared.security.tls_policy) لا سياق مُضمَّن: http⇒None ·
# https loopback+INSECURE_TLS⇒بلا تحقّق · https بعيد⇒تحقّق (لا تعطيل صامت). حارس test_tls_policy
# يفرض أنّ أيّ معطِّل CERT_NONE يمرّ عبر هذه السياسة.
