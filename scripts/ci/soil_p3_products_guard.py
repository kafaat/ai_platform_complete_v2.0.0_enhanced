...
required = [
    "shared/contracts/soil/p3.py",
    "services/soil-service/p3_products.py",
    "services/soil-service/p3_store.py",
    "services/soil-service/routers/p3_products.py",
    "services/soil-service/test_soil_p3_products.py",
...
for table in [
    ...
    "soil_drainage_assessments",
    "soil_reclamation_assessments",
