...
ag = (ROOT / "services/agriai-engine/agronomic_context.py").read_text(encoding="utf-8")
...
override = (ROOT / "docker-compose.soil-strict.yml").read_text(encoding="utf-8")
for token in (
...
canonical = (ROOT / "services/soil-service/routers/canonical.py").read_text(encoding="utf-8")
