...
required = {
    "migrations/v158_soil_projection_observability.sql": [
        "sahool_soil_projection_queue_stats",
        "SECURITY DEFINER",
        "REVOKE ALL",
    ],
    "services/soil-service/projection_observability.py": [
        "soil_projection_queue_oldest_ready_age_seconds",
        "readiness_policy",
        "WORKER_UP",
    ],
    "services/soil-service/routers/health.py": [
        "/v1/soil/projection/status",
