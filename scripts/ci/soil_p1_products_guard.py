...
required = [
    "migrations/v161_soil_p1_products.sql",
    "shared/contracts/soil/p1.py",
    "services/soil-service/p1_products.py",
    "services/soil-service/p1_store.py",
    "services/soil-service/routers/p1_products.py",
    "services/soil-service/test_soil_p1_products.py",
]
for f in required:
...
for table in [
    ...
    "soil_sampling_plans",
    "soil_hydraulic_profiles",
    "irrigation_water_samples",
