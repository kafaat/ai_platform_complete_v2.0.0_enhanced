...
req={
 ...
 'services/soil-service/routers/p4_workflow.py':['/soil/actions/{action_type}/evaluate','/soil/executions','/soil/closed-loop'],
 'shared/contracts/soil/p4.py':['SoilExecutionRecord','SoilVerificationRecord','SoilOutcomeRecord','SoilLearningAttribution'],
}
