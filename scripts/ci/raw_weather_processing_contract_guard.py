...
def main() -> int:
    ...
    checks = {
        "raw weather runtime module": "class RawWeatherProcessRequest" in raw
        and "build_raw_weather_response" in raw,
        ...
        "raw logic not in main": "RawWeatherProcessRequest" not in entry
        and "build_raw_weather_response" not in entry,
        ...
        "docker liveness healthz": "/healthz" in docker
        and "/readyz" not in docker.split("HEALTHCHECK", 1)[-1],
    }
