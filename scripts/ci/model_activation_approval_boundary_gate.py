...
migration = (root / "services/decision-service/migrations/012_model_activation_approval_command.sql").read_text()
...
for forbidden in ('model.fit(', 'partial_fit(', 'optimizer.step(', 'set_alias(', 'update_alias(', 'deploy_model(', 'mqtt.publish(', 'actuator'):
