...
migration = (root / "services/decision-service/migrations/011_model_activation_request.sql").read_text()
...
for forbidden in ('model.fit(', 'partial_fit(', 'optimizer.step(', 'registry_alias', 'active_model', 'deploy_model', 'mqtt.publish(', 'actuator'):
