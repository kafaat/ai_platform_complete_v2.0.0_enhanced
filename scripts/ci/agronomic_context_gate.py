...
mig = (ROOT / "services/decision-service/migrations/018_ac1_agronomic_context.sql").read_text(encoding="utf-8")
...
contracts = (ROOT / "services/decision-service/agronomic_context/contracts.py").read_text(encoding="utf-8")
pit = (ROOT / "services/decision-service/agronomic_context/point_in_time.py").read_text(encoding="utf-8")
