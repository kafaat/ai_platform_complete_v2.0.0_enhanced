...
migration = (root / "services/decision-service/migrations/010_model_promotion_decision.sql").read_text()
...
for forbidden in ('model.fit(', 'partial_fit(', 'optimizer.step(', 'active_model', 'registry_alias', 'mqtt.publish(', 'actuator'):
