...
class StreamableHTTPTransport:
    ...
    def _register_routes(self):
        ...
        async def stream_endpoint(request: Request):
            ...
            # Cancellation support via client timeout
            timeout = request.headers.get("Mcp-Request-Timeout", "30")
            ...
            async def event_generator() -> AsyncGenerator[str, None]:
                try:
                    ...
                    _timeout_err = {'jsonrpc': '2.0', 'error': {'code': -32000, 'message': 'Request timeout'}, 'id': body.get('id')}
                    yield f"data: {json.dumps(_timeout_err)}\n\n"
                except Exception as e:
                    _gen_err = {'jsonrpc': '2.0', 'error': {'code': -32603, 'message': str(e)}, 'id': body.get('id')}
