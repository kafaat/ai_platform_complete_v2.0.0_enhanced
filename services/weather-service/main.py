...
app.get("/v1/weather/thermal-stress")(rt.thermal_stress)
...
app.post("/v1/weather/agro/et0")(rt.agro_et0)
app.post("/v1/weather/agro/et0/series")(rt.agro_et0_series)
app.post("/v1/weather/agro/etc/hourly")(rt.agro_hourly_etc)
app.post("/v1/weather/agro/gdd")(rt.agro_gdd)
app.post("/v1/weather/agro/vpd")(rt.agro_vpd)
app.post("/v1/weather/agro/canonical-state")(rt.agro_canonical_state)
app.post("/v1/weather/agro/state-report")(rt.agro_weather_state_report)
