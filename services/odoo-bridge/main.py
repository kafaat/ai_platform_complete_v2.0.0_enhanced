...
# ══════════════════════════════════════════════════════════════
# Endpoints — استُخرجت إلى routers/ (تفكيك محفوظ السلوك).
# المُعالِجات نُقلت حرفيّاً إلى routers/{health,sync,webhooks,catalog}.py
# وتُسجَّل تلقائيّاً عبر register_routers(app) في نهاية الملفّ (بلا prefix).
# ══════════════════════════════════════════════════════════════


# تسجيل الراوترات يجري في النهاية بعد تعريف app وكلّ التبعيّات المشتركة
# (الحالة/المساعِدات/النماذج) — يُحلّ الاستيراد الدائريّ (routers تستورد main).
