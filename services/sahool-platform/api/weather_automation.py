...
class WeatherAutomation:
    ...
    async def load_from_db(self) -> int:
        ...
        عابر للمستأجِرين بالتصميم: مجدوِل خلفيّ يسحب الطقس لكلّ الإحداثيّات
        المسجّلة عبر المستأجِرين، فلا يُضبط app.current_tenant على هذه الاتّصالات
        الخام قصداً. تحت الدور المُقيَّد (NOBYPASSRLS/FORCE RLS) تحتاج هذه المسارات
