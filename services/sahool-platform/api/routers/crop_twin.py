...
# DECISION-PATH: preview — تركيب حالة محصول مقروءة (compose، dry-run) على مدخلات
# يمرّرها المستدعي. لا يُوزَّع للتنفيذ؛ يُغذّي العرض/التخطيط لا التنفيذ المباشر.
# المسار القانونيّ للتنفيذ هو field_intelligence_coordinator.run_field_intelligence.
