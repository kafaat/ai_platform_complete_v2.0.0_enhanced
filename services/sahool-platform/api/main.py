...
# ─── إعادة تصدير نماذج المنصّة (استُخرِجت إلى api/platform_models.py) ──────────
# تُوضَع مبكّراً كي تتوفّر الأسماء لبقيّة الوحدة (توقيعات المسارات + الراوترات الـ127
# التي تستورد ``from api.main import <Model>``) وكي يعيد بناؤها ``_rebuild_pydantic_models``.
from api.platform_models import (  # noqa: E402,F401 — إعادة تصدير للتوافق
