...
async def _start_scheduler():
    ...
    async def _freshness_sweep():
        ...
        # رطوبة التربة عبر _latest_soil_moisture من soil_observations،
        # الطقس من weather_automation_cache)،
        ...
        for sys_user, field_id in pairs:
            try:
                async with tenant_connection(sys_user) as conn:
                    ...
                    # رطوبة التربة: أحدث قراءة صالحة من المخزن القانونيّ
                    # soil_observations (لا من جدول ابتلاع الأجهزة).
