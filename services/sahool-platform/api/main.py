...
# دفعة حصاد + سلسلة حيازة append-only. النماذج هنا (مركزيّة كبقيّة النماذج)،
# والمنطق النقيّ في core/engines/harvest_traceability، والمسارات في
# routers/harvest_traceability.
