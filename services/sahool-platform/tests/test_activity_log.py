...
from core.activity_log import (
    plan_activity_from_recommendation, mark_completed, mark_skipped,
    overdue_activities, activities_for_recommendation, adoption_summary,
    ActivityStatus, ActivityType, new_activity_id)


class TestPlanFromRecommendation:
    def test_plan_creates_planned_task(self):
        t = plan_activity_from_recommendation(
            tenant_id="t1", field_id="f1", rec_id="rec1",
            activity_type="irrigation", planned_date="2026-06-01",
            quantity=20.0, unit="mm")
    ...
    def test_unknown_type_falls_to_other(self):
        ...
        t = plan_activity_from_recommendation(
            tenant_id="t1", field_id="f1", rec_id="rec1",
            activity_type="weird_unknown_type", planned_date="2026-06-01")
...
class TestSkipping:
    def test_skip_records_reason(self):
        ...
        t = plan_activity_from_recommendation(
            tenant_id="t1", field_id="f1", rec_id="rec1",
            activity_type="fertilization", planned_date="2026-06-01")
...
class TestQueries:
    def test_overdue_filters_past_planned(self):
        past = plan_activity_from_recommendation(
            tenant_id="t1", field_id="f1", rec_id="r1",
            activity_type="irrigation", planned_date="2026-01-01")
        future = plan_activity_from_recommendation(
            tenant_id="t1", field_id="f1", rec_id="r2",
            activity_type="irrigation", planned_date="2099-01-01")
    ...
    def test_activities_for_recommendation(self):
        a1 = plan_activity_from_recommendation(tenant_id="t1", field_id="f1",
            rec_id="rec_A", activity_type="irrigation", planned_date="2026-06-01")
        a2 = plan_activity_from_recommendation(tenant_id="t1", field_id="f1",
            rec_id="rec_B", activity_type="irrigation", planned_date="2026-06-02")
...
class TestAdoptionSummary:
    def test_adoption_rate_calculation(self):
        ...
        acts = []
        for i in range(2):
            t = plan_activity_from_recommendation(tenant_id="t1", field_id="f1",
                rec_id=f"r{i}", activity_type="irrigation", planned_date="2026-06-01")
            mark_completed(t)
            acts.append(t)
        skipped = plan_activity_from_recommendation(tenant_id="t1", field_id="f1",
            rec_id="r2", activity_type="fertilization", planned_date="2026-06-01")
    ...
    def test_all_pending_returns_none_rate(self):
        ...
        t = plan_activity_from_recommendation(tenant_id="t1", field_id="f1",
            rec_id="r1", activity_type="irrigation", planned_date="2026-06-01")
