...
from core.historical_loader import (
    load_csv, load_json, to_calibration_records, group_by_tenant, import_summary,
    HistoricalRow, LoadResult)
...
class TestCSVValidation:
    ...
    def test_invalid_date_format_rejected(self):
        ...
        csv_text = ("tenant_id,field_id,season,crop_id,actual_yield_t_ha,harvest_date\n"
...
class TestJSONLoad:
    def test_valid_json_list_accepted(self):
        json_text = ('[{"tenant_id":"t1","field_id":"f1","season":"2024",'
...
class TestCalibrationBridge:
    def test_to_calibration_records_format(self):
        rows = [HistoricalRow(tenant_id="t1", field_id="f1", season="2024",
                              crop_id="wheat", actual_yield_t_ha=3.5,
                              planted_area_ha=2.0, source_file="test.csv")]
