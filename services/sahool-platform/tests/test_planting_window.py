...
from core.engines.planting_window import days_to_accumulate_gdd, find_planting_window
...
class TestPlantingWindow:
    ...
    def test_finds_safe_window(self):
        ...
        r = find_planting_window(
            flowering_gdd=800,
            daily_gdd_by_sowing=self._gdd(),
            daily_tmax_by_sowing=tmax,
            heat_threshold_c=31.0,
        )
    ...
    def test_frost_tradeoff_warning(self):
        ...
        r = find_planting_window(
            flowering_gdd=500,
            daily_gdd_by_sowing={0: [10] * 100},
            daily_tmax_by_sowing=tmax,
            heat_threshold_c=31.0,
            frost_risk_offset_days=20,
        )
        assert r.frost_risk
