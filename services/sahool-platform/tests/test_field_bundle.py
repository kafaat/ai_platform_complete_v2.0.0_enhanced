...
class TestBundleBuilding:
    ...
    def test_boundary_converted_to_polygon_feature(self):
        b = build_bundle(
            field_id="f1", boundary_polygon=[(44.0, 16.0), (44.1, 16.0), (44.1, 16.1), (44.0, 16.1)]
        )
    ...
    def test_insufficient_points_warned_not_invented(self):
        ...
        b = build_bundle(field_id="f1", boundary_polygon=[(44.0, 16.0), (44.1, 16.0)])
        assert b.boundary_geojson is None
...
class TestResponseFormat:
    ...
    def test_sensor_location_carries_confidence(self):
        ...
        s = SensorLocation(
            "dev01", "soil_moisture", 44.05, 16.05, 35.5, "2026-05-27T10:00", "medium"
        )
