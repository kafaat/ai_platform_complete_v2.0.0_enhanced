...
def test_platform_route_budget_reduced_after_extractions():
    ...
    assert (
        budget <= 578
    )  # deliberately raised 567->570 (JSON-metrics hotfix); 575->576 WX-10.6 candidate; 576->577 WX-10.7 decision review; 577->578 WX-10.8 authoritative review-queue (owned+documented)
