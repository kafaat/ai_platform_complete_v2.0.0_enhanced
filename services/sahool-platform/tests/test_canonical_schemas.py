...
class TestSchemaCreation:
    ...
    def test_user_requires_role(self):
        u = UserSchema(user_id="u1", tenant_id="t1", role=UserRole.AGRONOMIST, name_ar="مهندس")
    ...
    def test_field_links_to_farm(self):
        ...
        f = FieldSchema(field_id="fld_1", tenant_id="t1", farm_id="frm_1", name_ar="حقل")
...
class TestValidation:
    def test_complete_field_passes(self):
        result = validate_entity(
            {"field_id": "fld_01", "tenant_id": "tnt_001", "farm_id": "frm_01", "name_ar": "اسم"},
            FieldSchema,
        )
        assert result.valid
    ...
    def test_missing_required_fails(self):
        ...
        result = validate_entity(
            {"field_id": "fld_01", "tenant_id": "tnt_001", "farm_id": "frm_01"}, FieldSchema
        )
    ...
    def test_short_tenant_id_invalid(self):
        ...
        result = validate_entity(
            {"field_id": "f", "tenant_id": "t", "farm_id": "fa", "name_ar": "x"}, FieldSchema
        )
        assert not result.valid
    ...
    def test_missing_schema_version_warns_not_fails(self):
        ...
        result = validate_entity(
            {"field_id": "fld_01", "tenant_id": "tnt_001", "farm_id": "frm_01", "name_ar": "x"},
            FieldSchema,
        )
        assert result.valid
