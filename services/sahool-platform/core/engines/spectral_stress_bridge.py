...
def index_coverage_report() -> dict:
    ...
    return {
        "decision_linked": {
            ...
            "msi": "الإجهاد المائي (محسوب عبر band_math/الشجرة ومربوط بالجسر) ✓",
        },
        ...
        "honesty_note_ar": (
            ...
            "للعرض/السياق. هذا مقصود (تجنّب ضوضاء)، لا نقص. ndmi/msi محسوبان "
            "ومربوطان بقرار الإجهاد المائي (كلاهما عبر band_math)."
        ),
    }
