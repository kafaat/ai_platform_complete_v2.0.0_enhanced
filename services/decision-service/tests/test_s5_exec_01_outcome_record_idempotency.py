...
def test_basic_outcome_replay_does_not_mutate_or_emit_second_event():
    src=(ROOT/'services/decision-service/persistence.py').read_text(); s=src.index('async def persist_outcome_record('); e=src.index('def _recommendation_outcome_request_hash',s); b=src[s:e]
