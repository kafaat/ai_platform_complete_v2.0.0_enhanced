...
def test_cas_and_generation_correctness():
    async def go():
        ...
        # One stored receipt set is reused across attempts (the semantic UNIQUE index makes the same
        # producer/check/env/provenance/build a single receipt referenced by UUID).
