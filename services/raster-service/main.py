...
from imagery_utils import (  # مساعِدات نقيّة مُستخرَجة (المرحلة 2) — تُعاد تصديرها
...
from models import (  # نماذج/تعدادات مُستخرَجة (المرحلة 1) — تُعاد تصديرها للمستورِدين
    AutoBackfillPolicy,
    BandMapping,
    BatchProcessRequest,
    ChangeDetectRequest,
...
# ─── النماذج/التعدادات: مُستخرَجة إلى models.py (المرحلة 1) ومستورَدة أعلاه ───
# ثوابت مُشتقّة تبقى هنا (منطق خدمة لا عقد بيانات):
