...
**الحالة:** ⏳ مسودّة للمراجعة — قرار ملكيّة واحد يجب حسمه قبل التنفيذ.
**السابق:** B1.2b (`scout-ingest-service` خدمة مالكة، `eaf3096`). **التالي بعدها:** B1.4 (Kobo).
...
## 6. سؤال المراجعة الوحيد
**اعتماد (أ) [موصى] أم (ب)؟** — أي: هل يملك scout-ingest جدول إسقاطه الخاصّ ويؤجَّل توحيد العرض مع
FieldView لقرار B1.3b صريح (أ)، أم تكسب المنصّة عامل إسقاط يكتب `scouting_pins` فيُوحَّد العرض فوراً بثمن
نموّ المنصّة (ب)؟
