...
| `/v1/auth/change-password` | farmer | — |
| `/v1/auth/edge-sign` | farmer | — |
| `/v1/auth/invitations` | farmer | — |
| `/v1/auth/invitations/accept` | farmer | — |
| `/v1/auth/invitations/{invitation_id}` | farmer | — |
| `/v1/auth/login` | farmer | — |
| `/v1/auth/logout` | farmer | — |
| `/v1/auth/me` | farmer | — |
| `/v1/auth/mfa/activate` | farmer | — |
| `/v1/auth/mfa/disable` | farmer | — |
| `/v1/auth/mfa/setup` | farmer | — |
| `/v1/auth/password-reset/confirm` | farmer | — |
| `/v1/auth/password-reset/request` | farmer | — |
| `/v1/auth/refresh` | farmer | — |
| `/v1/auth/register` | farmer | — |
| `/v1/auth/tenants` | farmer | — |
| `/v1/auth/users` | farmer | — |
| `/v1/auth/users/{user_id}/deactivate` | farmer | — |
| `/v1/auth/users/{user_id}/role` | farmer | — |
| `/v1/auth/verify` | farmer | — |
| `/v1/auth/verify/confirm` | farmer | — |
| `/v1/auth/verify/request` | farmer | — |
| `/v1/auth/verify/status` | farmer | — |
