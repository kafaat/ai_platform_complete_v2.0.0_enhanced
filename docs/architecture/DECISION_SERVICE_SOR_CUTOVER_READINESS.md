...
- Migration apply: `DECISION_SERVICE_ALLOW_SCHEMA_CHANGE=true python services/decision-service/migration_runner.py --apply`
- Backfill verification: `python services/decision-service/backfill.py --verify-counts`
- Runtime tests: real Postgres tenant isolation and outbox/idempotency checks
