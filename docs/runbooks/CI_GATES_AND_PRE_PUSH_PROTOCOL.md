...
| `capability-registry` (**٦٤** خطوة تكتشفها المكنسة) | **٩:٠٧** (#788) | ~٣ د |
| `Repository Tests (tests/)` | ~٥ د | ٥:١٧–٥:٢١ |
| **`Unit Tests`** — قبل §٣.٢٤ | **١٩:١٩–٢٠:١٠** (`c4938837`) · **١٩:٠٩** (#788) | ٦:٣٥ بالتغطية · ٤:٠٢ بدونها |
| **`Unit Tests`** — بعد دمج التشغيلين (§٣.٢٤) | **٨:١٤ مقيسة** (`03bd0fe3` · job 92322852732) — **٢.٣٣×** أسرع | ٦:٣٥ |
| `Security Scan` | ٤–٦ د | يعتمد على الشبكة |
| **الجولة الكاملة** (٦٤ فحصاً) | **١٩:١٨** (#788) — ٩٩٪ منها `Unit Tests` | ~١٢ د بـ`preflight --full` |
...
**والتوقّع قِيس ولم يُترَك توقّعاً.** أوّل جولة بعد الدمج (`03bd0fe3`، الوظيفة
`92322852732`) طبعت `494.01s (0:08:14)` مقابل **١٩:٠٩** على #788 — أي **٢.٣٣×**، وهو
أفضل من التنصيف المتوقَّع (~٩:٣٥) لأنّ التجهيز الثابت (التثبيت، الاستيراد، الجمع) كان
يُدفَع مرّتين أيضاً.
