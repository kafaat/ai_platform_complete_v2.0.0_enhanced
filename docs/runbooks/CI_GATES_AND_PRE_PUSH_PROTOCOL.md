...
| `capability-registry` (٤٧ خطوة توليد) | ٣–٥ د | ~٣ د |
| `Repository Tests (tests/)` | ~٥ د | ٥:١٧–٥:٢١ |
| **`Unit Tests`** | **١٩:١٩–٢٠:١٠** (`c4938837`) | ٥:٠٨–٥:٢٤ |
| `Security Scan` | ٤–٦ د | يعتمد على الشبكة |
| **الجولة الكاملة** | **~٢٠ د** | ~١٢ د بـ`preflight --full` |

فكلّ فشل يُكتشَف في CI يكلّف **~٢٠ دقيقة ثمّ ٢٠ أخرى** بعد الإصلاح، بينما `--full`
محلّيّاً يقطعه في ~١٢. و`main` يتحرّك أثناء ذلك: في جلسة واحدة تحرّك
...
2. **مولّد أو workflow جديد** ⇒ تُحدَّث الأرقام (٤٧ خطوة · ١٨ workflow · ٢٠٩ بوّابة ·
   ٧٠ مُغطّاة). رقمٌ بائت أسوأ من غياب الرقم لأنّه يُقرَأ قياساً.
