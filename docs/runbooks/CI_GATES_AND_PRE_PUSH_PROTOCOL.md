...
| **`Unit Tests`** — بعد دمج التشغيلين (§٣.٢٤) | **١١:٢٨ مقيسة** (`03bd0fe3` · job 92323013667) — **١.٦٧×** · موفَّر **٧:٤١** | ٦:٣٥ |
...
**١.٦٧× · موفَّر ٧:٤١ من كلّ PR.** وأوّل ما كتبتُه كان «٢.٣٣×» لأنّي قارنتُ **مدّة
