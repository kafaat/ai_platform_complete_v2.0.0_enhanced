...
- حرّاس تحجب في CI: **238**
- منها **مُثبَتة بالتكذيب** (لها مواصفة طفرة نُفِّذت): **27**
- إجماليّ الطفرات المُسجَّلة: **176**
...
**يفرض:** حارس المسارات المجمَّدة خلف GATE-01 — يجعل حكم المالك تنفيذيّاً لا نثريّاً.
...
- نزعُ الكشف نفسه ⇒ يمرّ مسٌّ لمسارٍ مجمَّد أخضر، وهو بالحرف الحادثة التي وقعت مرّتين وأُرجِعت رقعتُها بايتاً في المرّتين. — يُسقِط `test_touching_a_frozen_path_is_blocked`
- قلبُ الشرط إلى «كلّ ما ليس CLOSED مفتوح» يجعل حقلاً مشوَّهاً أو غائباً إذناً — والافتراضيّ يصير المرور لا الإغلاق، وهو أخطر من غياب الحارس لأنّ خضرته تُقرأ تصريحاً. — يُسقِط `test_any_state_that_is_not_open_fails_closed`
- قائمةٌ فارغة تجعل الحارس يمرّ على كلّ شيء دائماً — خضرةٌ عن سؤالٍ لم يُطرَح، ويُلغى الحارس بتفريغ حقلٍ واحد بدل حذف ملفّ يُلاحَظ. — يُسقِط `test_an_empty_frozen_list_fails_closed`
