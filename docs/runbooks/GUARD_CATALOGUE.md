...
- إجماليّ الطفرات المُسجَّلة: **364**
...
- إسقاطُ شرط «كلُّ ما اختفى صفٌّ مكرَّر الهويّة» يُبقي الاستثناءَ يشترط نقصاً فقط ⇒ يصير أيُّ حذفٍ في سجلّ الفجوات مُعفًى ما دام الملفُّ يحوي مكرَّراً واحداً — وهو تحويلُ الاستثناء المبرهَن إلى بابٍ مفتوح — يُسقِط `test_the_exception_does_not_excuse_removing_a_row_that_was_never_duplicated`
- إسقاطُ شرط «الهويّة ما تزال مُعلَنةً بعد الضمّ» ⇒ حذفُ صفّي الهويّة معاً يمرّ استثناءً، فيختفي الصفُّ الحاكم من الجدول ويُقرأ النقصُ ضمّاً — العطلُ الذي أمسكته مراجعةُ Copilot على #988 — يُسقِط `test_the_exception_does_not_excuse_deleting_every_row_of_the_duplicated_identity`
- رفعُ حصر الاستثناء بالملفّ الوحيد الذي صفوفُه إعلاناتُ حالةٍ مفردة ⇒ يسري على `log.md` و`hot.md` بمجرّد أن يحوي نصُّهما ما **يشبه** صفّاً مكرَّراً، فيصير شكلُ المحتوى رخصةَ نقص — يُسقِط `test_the_exception_is_scoped_to_the_file_whose_rows_are_unique_declarations`
