...
- الطفرةُ D: إخراجُ المصرف من السجلّ عمليّاً — حارسٌ لا يطابق شيئاً يمرّ أخضر على شجرةٍ منتهَكة، وهو «أخضرُ عن سؤالٍ لم يُطرَح». — يُسقِط `test_a_new_compose_file_carrying_the_sink_is_seen`
