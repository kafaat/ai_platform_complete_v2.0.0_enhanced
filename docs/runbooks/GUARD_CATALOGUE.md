...
- قبولُ دورٍ يتخطّى RLS ⇒ كلّ ادّعاء عزلٍ تحته يمرّ مجّاناً، والأدلّة تبقى خضراء وهي لا تقيس عزلاً — يُسقِط `test_an_unrestricted_role_is_a_failure`
