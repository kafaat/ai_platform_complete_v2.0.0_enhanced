...
الأساس المقارن `799842d3`؛ الشيفرة الأساسية والطفرات حتى `59c4eb8f`، وتصحيحات التحقق اللاحقة حتى `0d1d2eaa`.
...
- زمن مكنسة الطفرات: السجل بلغ **645** طفرة، فوق العلامة **642** وحد الانجراف **610** في `tests_v9/test_mutation_sweep_headroom.py`. اختبارا الحدّ أحمران؛ يلزم قياس CI يقرن زمن الجولة بعدد طفراتها. لا تُحذف الطفرات ولا تُرفع الحدود لمجرد الإغلاق.
