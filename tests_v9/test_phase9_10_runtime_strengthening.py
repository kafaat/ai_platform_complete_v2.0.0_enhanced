...
def test_phase9_10_strengthening_migration_registered():
    ...
    sql = Path("migrations/v106_phase9_10_runtime_strengthening.sql").read_text(encoding="utf-8")
...
def test_runtime_store_sets_rls_context_before_tenant_writes():
    src = Path("services/sahool-platform/api/phase_runtime_store.py").read_text(encoding="utf-8")
