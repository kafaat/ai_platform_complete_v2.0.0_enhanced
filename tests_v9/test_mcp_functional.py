...
@pytest.mark.xfail(
    ...
    reason=(
        ...
        "weather_server.py:147 يُعلن Depends(require_scope) و oauth_middleware.py:44 يرفع "
        "401 «Missing token» — لكنّ طبقة سابقة للحارس تُجيب أوّلاً. عيب ترتيب/رمز حالة، "
        "لا غياب حماية. أُوقظ الاختبار عمداً بدل إخفائه؛ يُرفع الوسم عند إصلاح الترتيب."
    ),
)
