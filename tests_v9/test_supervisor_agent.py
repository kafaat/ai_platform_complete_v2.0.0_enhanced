...
class TestSupervisorAgent:
    ...
    async def test_ndvi_query(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_irrigation_advice_query(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_optimize_farm(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_optimize_max_yield(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_optimize_min_water(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_arabic_response_format(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
    ...
    async def test_processing_time_under_5s(self, http_client: AsyncClient, mock_jwt_token: str, mock_field_data: dict):
...
class TestSupervisorRouter:
    ...
    async def test_intent_classification_irrigation(self, http_client: AsyncClient, mock_jwt_token: str):
