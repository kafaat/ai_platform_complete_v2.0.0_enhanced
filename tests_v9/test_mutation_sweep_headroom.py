...
#: أبطأُ قياسٍ حقيقيّ (دقائق) وقتَ آخر إعادةِ تبرير — تشغيل CI على رأس #887
#: (`46445690` · job 97043723680): ١٤:١٧:٤٠ → ١٥:١٨:١٠ = ٦٠٫٥ دقيقة.
#: (القياسُ الأسبق: ٥٩٫٠ على #882 عند ٤٠١ طفرة — محفوظٌ في تاريخ هذا الملفّ.)
MEASURED_SLOWEST_MINUTES = 60.5
...
#: شجرةُ ذلك التشغيل حملت اتّحادَ #886+#887 كاملاً عدا طفرةَ `preflight.sh` الواحدة.
MEASURED_MUTATIONS = 441

#: علامةُ الماء: تجاوزُها يوجب إعادةَ قياسٍ حقيقيّة قبل الدفع. **أُعيد تبريرُها
#: بالإجراء الذي يُمليه هذا العقد نفسُه** حين حمرّ على ٤٤٢ (اتّحادُ إرساءِ #888):
#: الهامشُ المتاح (٩٠ − ٦٠٫٥ = ٢٩٫٥ دقيقة) ÷ كلفةِ الطفرة المتحفّظة نفسِها التي
#: اشتقّت العلامةَ الأولى (~٤٦٫٥ث، من ٣١ دقيقة ÷ ٤٠ طفرة) ⇒ +٣٨ ⇒ ٤٧٩.
#: والتحفّظ مقصود: أن يحمرّ باكراً أرخص من أن يحمرّ بعد حرقِ تسعين دقيقة.
MUTATION_WATERMARK = 479
