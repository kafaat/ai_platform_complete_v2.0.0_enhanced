...
def test_crs_validation():
    ...
    from api.geospatial_integrity import validate_crs, ValidationSeverity
...
def test_field_validation_yemen():
    ...
    from api.geospatial_integrity import validate_field_geometry, ValidationSeverity
...
def test_utm_zones_yemen():
    ...
    from api.geospatial_integrity import check_bbox_in_utm_zones, is_valid_yemen_utm_zone, YEMEN_UTM_ZONES
