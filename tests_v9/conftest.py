...
def make_token(user_id: int = 1, role: str = "farmer",
               tenant_id: str = None, expired: bool = False) -> str:
...
def mock_field_data() -> dict:
    ...
    return {
        ...
        "geometry": {"type": "Polygon", "coordinates": [[
            [44.33, 16.79], [44.34, 16.79],
            [44.34, 16.80], [44.33, 16.80], [44.33, 16.79]]]},
    }
...
def mock_weather_data() -> dict:
    ...
    """
    return {
        "lat": 15.35, "lon": 44.20,   # صنعاء
        "tmin": 12.0, "tmax": 28.0, "tmean": 20.0,
        "date": "2026-06-09",
    }
