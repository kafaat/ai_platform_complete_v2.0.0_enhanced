...
def test_season_context_migration_is_expand_only_and_no_guessed_backfill():
    sql = (ROOT / "migrations/v193_prescriptions_season_context_expand.sql").read_text(encoding="utf-8")
...
def test_new_prescription_writes_require_season_id():
    source = (ROOT / "services/sahool-platform/api/routers/prescriptions.py").read_text(encoding="utf-8")
