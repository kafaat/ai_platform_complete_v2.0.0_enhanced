...
def test_frontend_contract_exposes_manual_volume():
    ...
    panel = (ROOT / "frontend/src/sections/IrrigationManualOperationsPanel.tsx").read_text(encoding="utf-8")
...
def test_backend_keeps_operator_declared_volume_out_of_ledger():
    backend = (ROOT / "services/sahool-platform/api/irrigation_manual_execution.py").read_text(encoding="utf-8")
