...
PUBLIC_ALLOWLIST: set[str] = {
    ...
    "/runtime-identity",  # هويّة بناء/صورة الخدمة (git_sha/build_id/image_digest) من ملفّ صورة للقراءة فقط — بنية تحتيّة تشغيليّة (provenance) لربط أدلّة التحقّق بالصورة المنشورة، لا بيانات مستخدم/مستأجِر.
